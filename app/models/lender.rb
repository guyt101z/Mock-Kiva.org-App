class Lender < ActiveRecord::Base
	has_many :transfers
	has_many :borrowers, through: :transfers
  ...
  #before the lender gets added to DB, run this function.
  before_save :encrypt_password

 	#this method encrypts the lender's unencrypted login attempt and returns true if the password is a match
	def full_name
	...
	# class method that checks whether the lender's email and submitted password are valid
